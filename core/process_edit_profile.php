...
$current_user_data = get_user_info($pdo, $userID);
$current_display_name = $current_user_data['user_display_name'];
$current_bio = $current_user_data['user_bio'];
...
$result = update_user_profile($pdo, $userID, $is_display_name_updated ? $user_display_name : null, $is_bio_updated ? $bio : null);
